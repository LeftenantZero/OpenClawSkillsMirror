...
# === Skill 固定配置（由构建器生成） ===
SKILL_CONFIG = json.loads('{"example": "电影感城市夜景，镜头缓慢推进，灯光倒映在湿润路面", "keywords": "Seedance、Seed Dance、即梦视频、字节 Seedance、豆包 Seedance、文生视频、图生视频、参考生视频、AI视频、视频生成、广告、TVC、带货、种草、短剧、漫剧", "models": {"edit": "public_model_seedance_2_5_video_edit", "extend": "public_model_seedance_2_5_video_extend", "i2v": "public_model_seedance_2_5_i2v", "r2v": "public_model_seedance_2_5_r2v", "t2v": "public_model_seedance_2_5_t2v"}, "name": "seedance", "rule": "optional", "search": "覆盖 Seedance、Seed Dance、即梦视频、字节 Seedance、豆包 Seedance 的裸接口与全部公开模式", "title": "Seedance 视频生成"}')
