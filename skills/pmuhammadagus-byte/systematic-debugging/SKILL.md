...
description: "Gunakan saat ada bug/error: test failure, behavior tak terduga, masalah performa, atau build broken."metadata:
  openclaw:
    version: 1.0.0
---

# systematic-debugging — X∞ Compliance Layer

## 1. IDENTITY
Skill milik user: `systematic-debugging`. Mengikuti Skill Architecture Standard X∞ (wajib).
...
version: 1.1.0
description: Use when encountering bugs or unexpected behavior - systematic approach to finding root causes
