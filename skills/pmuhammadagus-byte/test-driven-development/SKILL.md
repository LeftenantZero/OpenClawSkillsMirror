...
description: "Gunakan saat membuat fitur baru, bug fix, refactoring, atau perubahan behavior—dengan menulis test dulu, lihat gagal, lalu tulis kode minimal untuk lewat. Aktif saat user minta "pakai TDD", "test-first", atau "red-green-refactor"."
metadata:
  openclaw:
    version: 1.0.0
---
...
# test-driven-development — X∞ Compliance Layer

## 1. IDENTITY
Skill milik user: `test-driven-development`. Mengikuti Skill Architecture Standard X∞ (wajib).

## 2. PURPOSE
Tulis test dulu, lihat gagal (RED), tulis kode minimal untuk lewat (GREEN), lalu refactor. Tanpa test gagal dulu, Anda tidak tahu apakah kode menguji hal yang benar.
