...
1. 2027届本科及以上学历在读，计算机、统计等相关专业优先；
...
包含岗位概览、面试轮次、常见问题、可跳转引用，以及帖子原文、图片和 OCR 归档。

<img src="docs/images/example-summary-output.png" alt="面经汇总完整输出示例" width="1200">

### 面经回答输出

结合个人简历和面试准备材料生成回答，并明确标注面经来源与个人材料依据。

<img src="docs/images/example-answer-output.png" alt="有引用的个性化面经回答完整输出示例" width="1200">
